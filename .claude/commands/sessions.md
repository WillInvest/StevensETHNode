...
Manage Claude Code session history - list, load, alias, and edit sessions stored in `/home/stevensbc/stevens-blockchain/.claude/sessions/`.
...
console.log('Path: /home/stevensbc/stevens-blockchain/.claude/sessions/' + session.filename);
console.log('');
...
- Sessions are stored as markdown files in `/home/stevensbc/stevens-blockchain/.claude/sessions/`
- Aliases are stored in `/home/stevensbc/stevens-blockchain/.claude/session-aliases.json`
