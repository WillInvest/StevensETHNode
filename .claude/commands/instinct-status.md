...
```bash
python3 /home/stevensbc/stevens-blockchain/.claude/skills/continuous-learning-v2/scripts/instinct-cli.py status
```
...
2. Read project instincts from `/home/stevensbc/stevens-blockchain/.claude/homunculus/projects/<project-id>/instincts/`
3. Read global instincts from `/home/stevensbc/stevens-blockchain/.claude/homunculus/instincts/`
