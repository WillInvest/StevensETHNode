...
Bash({
  command: "/home/stevensbc/stevens-blockchain/.claude/bin/codeagent-wrapper {{LITE_MODE_FLAG}}--backend <codex|gemini> {{GEMINI_MODEL_FLAG}}resume <SESSION_ID> - \"$PWD\" <<'EOF'
...
Bash({
  command: "/home/stevensbc/stevens-blockchain/.claude/bin/codeagent-wrapper {{LITE_MODE_FLAG}}--backend <codex|gemini> {{GEMINI_MODEL_FLAG}}- \"$PWD\" <<'EOF'
ROLE_FILE: <role prompt path>
<TASK>
Requirement: <task description>
Context: <plan content + target files>
...
| Phase | Codex | Gemini |
|-------|-------|--------|
| Implementation | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/codex/architect.md` | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/frontend.md` |
| Review | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/codex/reviewer.md` | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/reviewer.md` |
...
1. Call Gemini (use `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/frontend.md`)
...
1. Call Codex (use `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/codex/architect.md`)
2. Input: Plan content + retrieved context + target files
3. OUTPUT: `Unified Diff Patch ONLY. Strictly prohibit any actual modifications.`
...
1. **Codex Review** (`run_in_background: true`):
   - ROLE_FILE: `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/codex/reviewer.md`
...
2. **Gemini Review** (`run_in_background: true`):
   - ROLE_FILE: `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/reviewer.md`
   - Input: Changed Diff + target files
