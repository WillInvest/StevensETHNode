...
# New session call
Bash({
  command: "/home/stevensbc/stevens-blockchain/.claude/bin/codeagent-wrapper {{LITE_MODE_FLAG}}--backend codex - \"$PWD\" <<'EOF'
...
# Resume session call
Bash({
  command: "/home/stevensbc/stevens-blockchain/.claude/bin/codeagent-wrapper {{LITE_MODE_FLAG}}--backend codex resume <SESSION_ID> - \"$PWD\" <<'EOF'
ROLE_FILE: <role prompt path>
<TASK>
Requirement: <enhanced requirement (or $ARGUMENTS if not enhanced)>
Context: <project context and analysis from previous phases>
...
| Phase | Codex |
|-------|-------|
| Analysis | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/codex/analyzer.md` |
| Planning | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/codex/architect.md` |
| Review | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/codex/reviewer.md` |
