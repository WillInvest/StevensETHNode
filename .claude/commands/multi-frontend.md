...
# New session call
Bash({
  command: "/home/stevensbc/stevens-blockchain/.claude/bin/codeagent-wrapper {{LITE_MODE_FLAG}}--backend gemini --gemini-model gemini-3-pro-preview - \"$PWD\" <<'EOF'
...
# Resume session call
Bash({
  command: "/home/stevensbc/stevens-blockchain/.claude/bin/codeagent-wrapper {{LITE_MODE_FLAG}}--backend gemini --gemini-model gemini-3-pro-preview resume <SESSION_ID> - \"$PWD\" <<'EOF'
ROLE_FILE: <role prompt path>
<TASK>
Requirement: <enhanced requirement (or $ARGUMENTS if not enhanced)>
Context: <project context and analysis from previous phases>
...
| Phase | Gemini |
|-------|--------|
| Analysis | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/analyzer.md` |
| Planning | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/architect.md` |
| Review | `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/reviewer.md` |
...
- ROLE_FILE: `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/analyzer.md`
- Requirement: Enhanced requirement (or $ARGUMENTS if not enhanced)
...
- ROLE_FILE: `/home/stevensbc/stevens-blockchain/.claude/.ccg/prompts/gemini/architect.md`
