...
```bash
python3 /home/stevensbc/stevens-blockchain/.claude/skills/continuous-learning-v2/scripts/instinct-cli.py projects
```
...
1. Read `/home/stevensbc/stevens-blockchain/.claude/homunculus/projects.json`
