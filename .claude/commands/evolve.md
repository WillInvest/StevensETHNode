...
```bash
python3 /home/stevensbc/stevens-blockchain/.claude/skills/continuous-learning-v2/scripts/instinct-cli.py evolve [--generate]
```
...
6. If `--generate` is passed, write files to:
   - Project scope: `/home/stevensbc/stevens-blockchain/.claude/homunculus/projects/<project-id>/evolved/`
   - Global fallback: `/home/stevensbc/stevens-blockchain/.claude/homunculus/evolved/`
