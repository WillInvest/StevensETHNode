...
```bash
python3 /home/stevensbc/stevens-blockchain/.claude/skills/continuous-learning-v2/scripts/instinct-cli.py promote [instinct-id] [--force] [--dry-run]
```
...
4. Write promoted instincts to `/home/stevensbc/stevens-blockchain/.claude/homunculus/instincts/personal/` with `scope: global`
