...
3. **Determine save location:**
   ...
   - **Global** (`/home/stevensbc/stevens-blockchain/.claude/skills/learned/`): Generic patterns usable across 2+ projects (bash compatibility, LLM API behavior, debugging techniques, etc.)
