...
/** Get the Claude config directory (/home/stevensbc/stevens-blockchain/.claude) */
export function getClaudeDir(): string;

/** Get the sessions directory (/home/stevensbc/stevens-blockchain/.claude/sessions) */
export function getSessionsDir(): string;

/** Get the learned skills directory (/home/stevensbc/stevens-blockchain/.claude/skills/learned) */
