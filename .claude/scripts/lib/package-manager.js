 ...
 * 5. Global user preference (in /home/stevensbc/stevens-blockchain/.claude/package-manager.json)
...
function getSelectionPrompt() {
  ...
  message += '  - Or add to /home/stevensbc/stevens-blockchain/.claude/package-manager.json: {"packageManager": "pnpm"}\n';
