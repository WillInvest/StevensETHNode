...
Options:
  ...
  --global <pm>   Set global preference (saves to /home/stevensbc/stevens-blockchain/.claude/package-manager.json)
...
function setGlobal(pmName) {
  ...
  try {
    ...
    console.log('  Saved to: /home/stevensbc/stevens-blockchain/.claude/package-manager.json');
    console.log('');
  } catch (err) {
