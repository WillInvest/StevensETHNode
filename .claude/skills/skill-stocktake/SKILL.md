...
| Path | Description |
|------|-------------|
| `/home/stevensbc/stevens-blockchain/.claude/skills/` | Global skills (all projects) |
...
**Results cache:** `/home/stevensbc/stevens-blockchain/.claude/skills/skill-stocktake/results.json`

## Quick Scan Flow

Re-evaluate only skills that have changed since the last run (5–10 min).

1. Read `/home/stevensbc/stevens-blockchain/.claude/skills/skill-stocktake/results.json`
2. Run: `bash /home/stevensbc/stevens-blockchain/.claude/skills/skill-stocktake/scripts/quick-diff.sh \
         /home/stevensbc/stevens-blockchain/.claude/skills/skill-stocktake/results.json`
   (Project dir is auto-detected from `$PWD/.claude/skills`; pass it explicitly only if needed)
3. If output is `[]`: report "No changes since last run." and stop
4. Re-evaluate only those changed files using the same Phase 2 criteria
5. Carry forward unchanged skills from previous results
6. Output only the diff
7. Run: `bash /home/stevensbc/stevens-blockchain/.claude/skills/skill-stocktake/scripts/save-results.sh \
         /home/stevensbc/stevens-blockchain/.claude/skills/skill-stocktake/results.json <<< "$EVAL_RESULTS"`

## Full Stocktake Flow

### Phase 1 — Inventory

Run: `bash /home/stevensbc/stevens-blockchain/.claude/skills/skill-stocktake/scripts/scan.sh`
...
```
Scanning:
  ✓ /home/stevensbc/stevens-blockchain/.claude/skills/         (17 files)
...
```json
{
  ...
  "skills": {
    "skill-name": {
      "path": "/home/stevensbc/stevens-blockchain/.claude/skills/skill-name/SKILL.md",
      "verdict": "Keep",
