...
#
# Hook config (in /home/stevensbc/stevens-blockchain/.claude/settings.json):
# {
#   "hooks": {
#     "Stop": [{
#       "matcher": "*",
...
# Extracted skills saved to: /home/stevensbc/stevens-blockchain/.claude/skills/learned/
...
if [ -f "$CONFIG_FILE" ]; then
  if ! command -v jq &>/dev/null; then
    ...
    LEARNED_SKILLS_PATH=$(jq -r '.learned_skills_path // "/home/stevensbc/stevens-blockchain/.claude/skills/learned/"' "$CONFIG_FILE" | sed "s|~|$HOME|")
  fi
fi
